...
@section('content')
    ...
    <div class="container">
        <form role="form" action="{{route('teacher.teacherUpdate',['teacher_id'=>$teacher->id])}}" method="POST"
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select style="width: 100%" class="js-example-theme-single form-control"
                                            ...
                                            @foreach($positions as $position)
                                                <option {{$position->id==$teacher->position->id?'selected':''}} value="{{$position->id}}">{{$position->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
